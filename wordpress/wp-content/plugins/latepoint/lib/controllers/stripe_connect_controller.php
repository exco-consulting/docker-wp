...
if ( ! class_exists( 'OsStripeConnectController' ) ) :
	...
	class OsStripeConnectController extends OsController {
		...
		public function start_connect_process() {
			...
			$this->send_json( array( 'status' => LATEPOINT_STATUS_SUCCESS, 'url' => $url, 'message' => __( 'Redirecting to Stripe', 'latepoint-payments-stripe' ) ) );
		}
		...
		public function create_payment_intent() {
			try {
				...
				$order_intent->update_attributes( [
					'cart_items_data' => json_encode( $cart_items_data ),
