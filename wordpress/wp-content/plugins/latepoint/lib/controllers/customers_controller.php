    ...
    public function destroy(){
      ...
      if($this->get_return_format() == 'json'){
		...
		public function view_customer_log(){
			...
			$activities = $activities->where(['customer_id' => $this->params['customer_id']])->order_by('id desc')->get_results_as_models();
    ...
    */
    ...
    public function edit_form(){
      ...
      if(filter_var($this->params['id'], FILTER_VALIDATE_INT)){
				...
				$customer = $customer->where([LATEPOINT_TABLE_CUSTOMERS.'.id' => $this->params['id']])->filter_allowed_records()->set_limit(1)->get_results_as_models();
	      $this->vars['customer'] = $customer;
