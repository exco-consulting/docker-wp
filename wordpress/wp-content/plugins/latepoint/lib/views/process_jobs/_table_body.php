...
if($jobs){
  foreach ($jobs as $job): ?>
    <tr>
      ...
      <td>
        <a class="latepoint-link" data-os-after-call="reload_process_jobs_table" href="#" data-os-prompt="<?php _e('Are you sure you want to run this job?', 'latepoint'); ?>" data-os-action="<?php echo OsRouterHelper::build_route_name('process_jobs', 'run_job'); ?>" data-os-params="<?php echo OsUtilHelper::build_os_params(['job_id' => $job->id], 'run_job_'.$job->id) ?>">
