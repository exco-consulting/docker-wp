...
<div class="latepoint-lightbox-footer right-aligned">
	<button type="button" data-os-after-call="reload_process_jobs_table" class="latepoint-btn latepoint-btn-primary" data-os-params="<?php echo OsUtilHelper::build_os_params(['action_ids' => [$action->id], 'job_id' => $job->id], 'run_job_'.$job->id); ?>" data-os-action="<?php echo OsRouterHelper::build_route_name('process_jobs', 'run_job');?>">
