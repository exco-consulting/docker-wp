...
?>
<div class="step-verify-w latepoint-step-content" data-step-code="<?php echo $current_step_code; ?>"
		...
		<div class="confirmation-info-w">
			...
			if($booking->order_item_id){
				...
				echo '<div class="scheduling-bundle-booking-summary">';
					...
					echo '<div class="part-of-bundle-message">'.sprintf(__('Scheduling this booking will use a slot from a bundle which is part of order #%s.', 'latepoint'), $order->confirmation_code).'</div>';
