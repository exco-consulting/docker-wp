<?php
if(!$show_days_only) echo '<div class="quick-availability-per-day-w side-sub-panel" data-trigger-form-order-item-id="'.$trigger_form_order_item_id.'" data-trigger-form-booking-id="'.$trigger_form_booking_id.'" data-agent-id="'.$booking->agent_id.'">'; ?>
