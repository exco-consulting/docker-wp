...
/** @var $filter array */
?>
<div class="le-day-view-wrapper" data-route-name="<?php echo OsRouterHelper::build_route_name('events', 'events_day_view'); ?>">
	<div class="le-day-info-section">
		<div class="le-day-info">
			<div class="le-day-number"><?php echo $target_date->format('j'); ?></div>
			<div class="le-day-month"><?php echo $target_date->format('M'); ?></div>
		</div>
		<div class="le-day-filters-wrapper">
			<div class="le-day-heading"><?php _e('Daily Schedule', 'latepoint'); ?></div>
	...
	<div class="le-day-schedule-wrapper">
		...
		echo '<div class="day-schedule-timeslots">';
			...
			for($i = $start_time; $i<$end_time; $i+= 60){
				...
				echo '<div class="day-schedule-timeslot" '.$hour_height_css.'><div class="day-schedule-timeslot-value">'.OsTimeHelper::minutes_to_hours_and_minutes($i, null, true, true).'</div></div>';
				echo '</div>';
			}
