<div class="os-form-w">
  <form action="" data-os-after-call="latepoint_wizard_item_editing_cancelled" data-os-pass-response="yes" data-os-output-target=".os-wizard-step-content-i" data-os-action="<?php echo OsRouterHelper::build_route_name('wizard', 'save_service'); ?>">
    <div class="os-row">
    ...
    <?php if(count($agents) > 1){ ?>
      <h3 class="sub-header"><span><?php _e('Assign Agents','latepoint'); ?></span></h3>
