...
<div class="os-mini-customer-profile-w">
	...
	<div class="os-mc-info-w">
		...
		<div class="os-mc-info">
			...
			<?php if (!empty($customer->email)) { ?><div class="mc-info-list-item"><span><?php _e('email:', 'latepoint'); ?></span><strong><?php echo esc_html($customer->email); ?></strong></div><?php } ?>
			<?php if (!empty($customer->phone)) { ?><div class="mc-info-list-item"><span><?php _e('phone:', 'latepoint'); ?></span><strong><?php echo esc_html($customer->phone); ?></strong></div><?php } ?>
		</div>
	</div>
