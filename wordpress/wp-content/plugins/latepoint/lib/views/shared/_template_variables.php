<div class="available-vars-block">
  ...
  <h4><?php _e('Order', 'latepoint'); ?></h4>
  <ul>
    <li><span class="var-label"><?php _e('Order ID#:', 'latepoint'); ?></span> <span class="var-code os-click-to-copy">{{order_id}}</span></li>
    <li><span class="var-label"><?php _e('Order Confirmation Code:', 'latepoint'); ?></span> <span class="var-code os-click-to-copy">{{order_code}}</span></li>
    <li><span class="var-label"><?php _e('Subtotal:', 'latepoint'); ?></span> <span class="var-code os-click-to-copy">{{order_subtotal}}</span></li>
    <li><span class="var-label"><?php _e('Total:', 'latepoint'); ?></span> <span class="var-code os-click-to-copy">{{order_total}}</span></li>
    <li><span class="var-label"><?php _e('Payments & Credits:', 'latepoint'); ?></span> <span class="var-code os-click-to-copy">{{order_payments_total}}</span></li>
    <li><span class="var-label"><?php _e('Balance Due:', 'latepoint'); ?></span> <span class="var-code os-click-to-copy">{{order_balance_due_total}}</span></li>
    <li><span class="var-label"><?php _e('Order Status:', 'latepoint'); ?></span> <span class="var-code os-click-to-copy">{{order_status}}</span></li>
    <li><span class="var-label"><?php _e('Order Fulfillment Status:', 'latepoint'); ?></span> <span class="var-code os-click-to-copy">{{order_fulfillment_status}}</span></li>
    <li><span class="var-label"><?php _e('Transactions Breakdown', 'latepoint'); ?></span> <span class="var-code os-click-to-copy">{{order_transactions_breakdown}}</span></li>
    <li><span class="var-label"><?php _e('Order Summary Breakdown:', 'latepoint'); ?></span> <span class="var-code os-click-to-copy">{{order_summary_breakdown}}</span></li>
  ...
  <ul>
    ...
    <li><span class="var-label"><?php _e('Booking Price:', 'latepoint'); ?></span> <span class="var-code os-click-to-copy">{{booking_price}}</span></li>
...
<div class="available-vars-block">
  ...
  <ul>
		...
		<li><span class="var-label"><?php _e('Type:', 'latepoint'); ?></span> <span class="var-code os-click-to-copy"> {{transaction_kind}}</span></li>
