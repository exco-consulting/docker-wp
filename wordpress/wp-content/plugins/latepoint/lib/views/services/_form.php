        ...
        <div class="os-row">
          <div class="os-col-lg-6">
            <div class="label-with-description">
              ...
              <div class="label-desc"><?php _e('This image is used on a service selection step in the booking form.', 'latepoint'); ?></div>
            </div>
          ...
          <div class="os-col-lg-6">
            <div class="label-with-description">
              <h3><?php _e('Service Tile Image', 'latepoint'); ?></h3>
              <div class="label-desc"><?php _e('This image is used when service is listed in [latepoint_resources] shortcode.', 'latepoint'); ?></div>
            </div>
      ...
      if($service->is_new_record()){
        ...
        if(OsRolesHelper::can_user('service__delete')) {
	        echo '<a href="#" class="latepoint-btn latepoint-btn-danger remove-service-btn" style="margin-left: auto;" 
                ...
                data-os-params="' . OsUtilHelper::build_os_params(['id' => $service->id], 'destroy_service_'.$service->id) . '" 
