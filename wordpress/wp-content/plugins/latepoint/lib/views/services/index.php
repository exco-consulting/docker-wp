...
<?php }else{ ?>
  ...
  <div class="no-results-w">
    ...
    <h2><?php _e('No Active Services Found', 'latepoint'); ?></h2>
...
<?php if($disabled_services){
    ...
    echo '<div class="disabled-items-open-trigger"><span>'.sprintf(_n('%d Disabled Service', '%d Disabled Services', count($disabled_services),'latepoint'), count($disabled_services)).'</span><i class="latepoint-icon latepoint-icon-chevron-down"></i></div>';
