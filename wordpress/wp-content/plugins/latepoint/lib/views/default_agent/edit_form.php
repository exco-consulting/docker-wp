	...
	<div class="white-box">
		<div class="white-box-header">
			<div class="os-form-sub-header">
				<h3><?php _e('Recipient of Notifications', 'latepoint') ?></h3>
			</div>
		</div>
		<div class="white-box-content">
				<form  data-os-success-action="reload" data-os-action="<?php echo OsRouterHelper::build_route_name('default_agent', 'update'); ?>">
					<div class="os-row">
						<div class="os-col-6">
...
<?php echo OsUtilHelper::pro_feature_block(__('To add more agents install the PRO addon', 'latepoint')); ?>