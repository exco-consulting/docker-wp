...
<div class="latepoint-w">
	...
	<h4><?php printf( __('Welcome %s', 'latepoint'), esc_html($customer->full_name)); ?></h4>
	<div class="latepoint-tabs-w">
		<div class="latepoint-tab-triggers customer-dashboard-tabs">
			<a href="#" data-tab-target=".tab-content-customer-bookings" class="active latepoint-tab-trigger"><?php _e('Appointments', 'latepoint'); ?></a>
			<a href="#" data-tab-target=".tab-content-customer-orders" class="latepoint-tab-trigger"><?php _e('Orders', 'latepoint'); ?></a>
			<a href="#" data-tab-target=".tab-content-customer-info-form" class="latepoint-tab-trigger"><?php _e('Profile', 'latepoint'); ?></a>
	    ...
	    <?php do_action('latepoint_customer_dashboard_before_appointments', $customer); ?>
			<?php if($future_bookings || $past_bookings || $cancelled_bookings || $not_scheduled_bundles){ ?>
				...
				<div class="latepoint-section-heading-w">
					<h5 class="latepoint-section-heading"><?php _e('Bundles', 'latepoint'); ?></h5>
					<div class="heading-extra"><?php printf( __('%d Bundles', 'latepoint'), count($not_scheduled_bundles)); ?></div>
				</div>
				<div class="customer-bookings-tiles">
					<?php
