							...
							<div class="booking-date-i">
								...
								<div class="booking-attendees">
									...
									if($max_capacity > 1) {
										...
										echo '<div class="booked-count-label">'.sprintf(__('Booked %d of %d', 'latepoint'), $total_attendees, $max_capacity).'</div>';
										echo '<div class="booked-percentage">
											<div class="booked-bar" style="width: '.min(100, round($total_attendees / $max_capacity * 100)).'%;"></div>
										</div>';
									}else{
