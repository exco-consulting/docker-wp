...
//			LatePoint\Cerber\Router::trace($addon_name, $addon_version);
		...
		function redirect_after_activation() {
			if ( get_option( 'latepoint_redirect_to_wizard', false ) ) {
				...
				if ( ! isset( $_GET['activate-multi'] ) ) {
					wp_redirect( OsRouterHelper::build_link( OsRouterHelper::build_route_name( 'updates', 'version_5_intro' ) ) );
				}
			}
		}
		...
		*/
		...
		public function load_front_scripts_and_styles() {
			...
			if ( OsSettingsHelper::is_using_facebook_login() ) {
				wp_add_inline_script( 'latepoint-main-front', $this->add_facebook_sdk_js_code() );
			}
...
//				wp_enqueue_style('latepoint-google-fonts', 'https://fonts.googleapis.com/css2?family=Overpass+Mono:wght@400;500;600&family=Overpass:wght@400;500;600&display=swap', false, null);
