...
if ( ! class_exists( 'OsTimezoneSelectorController' ) ) :
  ...
  class OsTimezoneSelectorController extends OsController {
    ...
    function __construct(){
      ...
      $this->action_access['public'] = array_merge($this->action_access['public'], ['change_timezone']);
      ...
      $this->vars['breadcrumbs'][] = array('label' => __('Timezone Selector', 'latepoint-pro-features'), 'link' => OsRouterHelper::build_link(OsRouterHelper::build_route_name('timezone_selector', 'index') ) );
    }
