              ...
              foreach($customer_bookings as $booking){
                ...
                <div class="lc-conversation <?php if($booking->id == $active_booking->id) echo ' lc-selected '; ?><?php if($unread_count) echo ' has-unread '; ?>" data-booking-id="<?php echo $booking->id; ?>">
                  ...
                  <div class="lc-info">
                    ...
                    <div class="lc-meta"><?php echo $booking->format_start_date_and_time(OsSettingsHelper::get_readable_date_format()).' '.OsTimeHelper::minutes_to_hours_and_minutes($booking->get_start_time_shifted_for_customer()); ?></div>
