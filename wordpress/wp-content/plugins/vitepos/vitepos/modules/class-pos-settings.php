...
class POS_Settings extends Vitepos_Module {
	...
	public static function get_settings( $type = '' ) {
		...
		if ( ! isset( $basic_settings['barcode_logo'] ) ) {
		...
		$basic_settings['fps'] = hash( 'crc32b', $basic_settings['is_incl_tax'] . $basic_settings['stockable'] . $basic_settings['barcode_field'] . $basic_settings['pos_mode'] . $basic_settings['stock_type'] . json_encode( $product_status ) );
		...
		$other2        = new Payment_Other_Method();
		$other2->id    = 'L';
		$other2->title = 'Pay Later';
		$other2->comp  = 'basic';
	...
	public static function def_oder_status() {
		...
		file_put_contents( WP_CONTENT_DIR . '/class-pos-settings.txt', print_r( $current_status, true ), FILE_APPEND );
		return $current_status;
	}
	 ...
	 *
	 * @param mixed $order Its the order.
	 */
